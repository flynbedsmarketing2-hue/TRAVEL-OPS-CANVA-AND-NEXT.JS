  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 px-4 py-10 sm:px-6 lg:px-0">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-blue-600">Scenario compare</p>
          <h1 className="text-3xl font-semibold text-slate-900">Compare variants</h1>
        </div>
        <Link href="/pricing/scenarios" className="rounded-full border px-4 py-2 text-xs font-semibold text-slate-600">
          Return to list
        </Link>
      </div>
